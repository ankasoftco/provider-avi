...
import (
	...
	"github.com/ankasoftco/provider-avi/apis"
	"github.com/ankasoftco/provider-avi/apis/v1alpha1"
	"github.com/ankasoftco/provider-avi/config"
	"github.com/ankasoftco/provider-avi/internal/clients"
	"github.com/ankasoftco/provider-avi/internal/controller"
	"github.com/ankasoftco/provider-avi/internal/features"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-avi"))
	if *debug {
