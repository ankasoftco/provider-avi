...
export TERRAFORM_PROVIDER_VERSION ?= 22.1.4
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-avi
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.vmware.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-avi_22.1.4
...
xpkg.build.provider-avi: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/avis/01-delete.yaml.tmpl.
